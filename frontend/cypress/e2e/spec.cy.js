...
describe("The Login and Edit Page", () => { 
  it("Try to login as user and upload test image", () => { 
    ...
    cy.get('[data-cy="image-upload"]').selectFile('cypress/fixtures/test_image.jpg', {force: true});
    ...
    cy.get('[data-cy="download"]', { timeout: 10000 }).should('be.visible').and('not.be.disabled');
